...
public class SimpleCapabilityTest {
    ...
    void performTest() throws MalformedURLException {
        ...
        caps.setCapability("platform", "WINDOWS_7_64"); // overrides values in capability set

        caps.setCapability("wm:name", "Mein Testname");
        caps.setCapability("wm:tags", "regression, sprint=32, feature=suche");
